...
const BLOCK_TYPES = [
  { label: <Filter1 />, style: "header-one" },
  { label: <Filter2 />, style: "header-two" },
  { label: <Filter3 />, style: "header-three" },
  { label: <Filter4 />, style: "header-four" },
  { label: <Filter5 />, style: "header-five" },
  { label: <Filter6 />, style: "header-six" },
  { label: <ChatBubble />, style: "blockquote" },
